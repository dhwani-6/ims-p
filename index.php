...
?>
	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  ...
			  <a class="nav-link" id="v-pills-invoice-tab" data-toggle="pill" href="#v-pills-invoice" role="tab" aria-controls="v-pills-invoice" aria-selected="false">invoice</a> 
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#forcastReportsTab">Inventory forcast</a>
						</li>
					...
					<div class="tab-content">
						...
						<div id="forcastReportsTab" class="container-fluid tab-pane fade">
							<br>
							<p>Select the data to view sales done for the selected time period and forecast inventory for that product</p>
							<div class="table-responsive" id="forcastReportsTableDiv"></div>
							<form action="model/forcast/dynamic_dropdown.php" method="post">
							...
							<select name="item" id="item" required>
								...
								<?php
								 ...
								 $saleDetailsSearchSql = 'SELECT * FROM item';
	...
	while($row = $saleDetailsSearchStatement->fetch(PDO::FETCH_ASSOC)){
								?>
							<option value="<?php echo $row['itemNumber'];?>"><?php echo $row['itemName'];?></option>
							<?php } ?>
						</select>
			  ...
			  <div class="tab-pane fade" id="v-pills-invoice" role="tabpanel" aria-labelledby="v-pills-invoice-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">invoice Details</div>
				  	<div class="card-body">
				  <!-- Div to show the ajax message from validations/db submission -->
				 	 <id="invoiceDetailsMessage"></div>

					  <form method="post" action="model/invoice/generate_invoice.php">
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  <label for="itemDetailsItemNumber">Item Number<span class="requiredIcon">*</span></label>
								  <input type="text" class="form-control" name="itemDetailsItemNumber" id="itemDetailsItemNumber" autocomplete="off">
							  ...
							  <div class="form-row">
								...
								<div class="form-row">
						<div class="form-group col-md-6">
						  <label for="customerDetailsCustomerFullName">Full Name of customer<span class="requiredIcon">*</span></label>
						  <input type="text" class="form-control" id="customerDetailsCustomerFullName" name="customerDetailsCustomerFullName">
						</div>
						<div class="form-row">
						  <div class="form-group col-md-3">
