...
--
INSERT INTO `invoice` (`itemNumber`, `productID`, `itemName`, `discount`, `quantity`, `unitPrice`, `customerFullName`, `customerMobile`, `customerEmail`, `customerAddress`, `customerCity`, `customerDistrict`) 
VALUES ('1', 34, 'First Bag', 0, 2, 1500, 'Bill Gates', '993737', 'bill@microsoft.com', '45, Palo Alto House, Marine Drive', 'Microsoft', 'Kurunegala');
